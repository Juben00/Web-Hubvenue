    ...
    <main class="w-full px-4 py-8 min-h-screen">
        <div class="max-w-7xl mt-16 mx-auto">
            ...
            <div class="flex mb-8 border-b border-gray-200 bg-white rounded-lg p-2 gap-2 shadow-sm">
                <button class="flex items-center gap-2 px-6 py-3 text-gray-600 rounded-lg transition-all duration-200 hover:bg-gray-100 hover:text-black data-[active=true]:bg-gray-100 data-[active=true]:text-black data-[active=true]:font-semibold" data-tab="account" data-active="true">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                    Account Settings
                </button>
                <button class="flex items-center gap-2 px-6 py-3 text-gray-600 rounded-lg transition-all duration-200 hover:bg-gray-100 hover:text-black data-[active=true]:bg-gray-100 data-[active=true]:text-black data-[active=true]:font-semibold" data-tab="notifications">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                    </svg>
                    Notifications
                </button>
                <button class="flex items-center gap-2 px-6 py-3 text-gray-600 rounded-lg transition-all duration-200 hover:bg-gray-100 hover:text-black data-[active=true]:bg-gray-100 data-[active=true]:text-black data-[active=true]:font-semibold" data-tab="privacy">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                    </svg>
                    Privacy
                </button>
                <button class="flex items-center gap-2 px-6 py-3 text-gray-600 rounded-lg transition-all duration-200 hover:bg-gray-100 hover:text-black data-[active=true]:bg-gray-100 data-[active=true]:text-black data-[active=true]:font-semibold" data-tab="discounts">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="mb-12 flex flex-col items-center">
                            <div class="relative group">
                                ...
                                <label for="profilePicture" class="absolute inset-0 flex items-center justify-center bg-black/50 text-white rounded-full opacity-0 group-hover:opacity-100 cursor-pointer transition-opacity duration-200">
                        ...
                        <form class="space-y-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    ></textarea>
                                    <p class="text-sm text-gray-500">Write a short bio that describes you (maximum 500 characters)</p>
                                </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    <div class="space-y-2">
                                        ...
                                        <input type="text" name="firstname" class="w-full h-12 px-3 py-2 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-colors">
                                    </div>
                                    <div class="space-y-2">
                                        <label class="block text-sm font-medium text-gray-700">Last Name</label>
                                        <input type="text" name="lastname" class="w-full h-12 px-3 py-2 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-colors">
                                    </div>
                                    <div class="space-y-2">
                                        <label class="block text-sm font-medium text-gray-700">Middle Initial</label>
                                        <input type="text" name="middlename" class="w-full h-12 px-3 py-2 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-colors">
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    <div class="space-y-2">
                                        ...
                                        <select name="sex" class="w-full h-12 px-3 py-2 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-colors">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input type="date" name="birthdate" class="w-full h-12 px-3 py-2 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-colors">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6 pt-6 border-t">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex gap-2">
                                        <input type="text" name="address" class="w-full h-12 px-3 py-2 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-colors" placeholder="Enter your address">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    <div class="space-y-2">
                                        ...
                                        <input type="email" name="email" class="w-full h-12 px-3 py-2 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-colors" placeholder="your.email@example.com">
                                    </div>
                                    <div class="space-y-2">
                                        <label class="block text-sm font-medium text-gray-700">Contact Number</label>
                                        <input type="tel" name="contact" class="w-full h-12 px-3 py-2 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-colors" placeholder="09XX XXX XXXX">
                                    </div>
                                </div>
                            </div>

                            <div class="pt-6 flex justify-end">
                                <button type="submit" class="inline-flex items-center justify-center gap-2 px-8 py-3 bg-black text-white font-semibold rounded-lg transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg min-w-[200px] hover:bg-gray-800">
                            ...
                            <form class="space-y-8">
                                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    <div class="space-y-2">
                                        ...
                                        <input type="password" name="current_password" class="w-full h-12 px-3 py-2 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-colors">
                                    </div>
                                    <div class="space-y-2">
                                        <label class="block text-sm font-medium text-gray-700">New Password</label>
                                        <input type="password" name="new_password" class="w-full h-12 px-3 py-2 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-colors">
                                    </div>
                                    <div class="space-y-2">
                                        <label class="block text-sm font-medium text-gray-700">Confirm New Password</label>
                                        <input type="password" name="confirm_password" class="w-full h-12 px-3 py-2 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition-colors">
                                    </div>
                                </div>
                ...
                <!-- Discounts Settings -->
                <div id="discounts-settings" class="transition-all duration-200 ease-in-out transform opacity-100 translate-x-0">
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="bg-white rounded-lg shadow p-6 mb-6">
                            ...
                            <div id="discountDetailsBox" class="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg hidden">
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="space-y-1 text-sm text-green-600">
                                            ...
                                            <img id="displayPhotoPreview" class="w-32 h-32 object-cover rounded-lg border border-green-200 mt-2" src="" alt="ID Photo">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                <p class="text-gray-600">Enable 20% discount for Senior Citizens and Persons with Disabilities (PWD)</p>
                                <button onclick="openDiscountModal()" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black">
