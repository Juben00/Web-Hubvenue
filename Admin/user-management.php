...
<head>
    ...
    <style>
   body {
        background-image: url('bg.jpg'); /* Uncomment this line */
        background-size: cover; /* Add this line to ensure the image covers the entire body */
        background-attachment: fixed; /* Add this to keep the background fixed while scrolling */
    }
        ...
        .sidebar-brand, .sidebar-heading, .nav-item {
        ...
        #sidebar.w-16 nav a, #sidebar.w-16 nav button {
            justify-content: center;
        }

        #sidebar.w-16 nav a svg, #sidebar.w-16 nav button svg {
            margin-left: 0;
            margin-right: 0;
        }
        ...
        #sidebar.w-16 nav a:hover, #sidebar.w-16 nav button:hover {
            border-radius: 0.5rem;
            width: calc(100% - 0.5rem);
        }
    ...
    .dark-mode table thead th,
    .dark-mode table tbody td {
        color: #E5E7EB; /* Lighter text color for tables */
    }

    .dark-mode .text-muted-foreground {
        color: #9CA3AF; /* Adjust muted text color */
    }
    ...
    .dark-mode .border-input {
        border-color: #374151; /* Adjust border color for inputs */
    }
    ...
    <div class="flex h-screen">
            ...
            <div id="sidebar" class="w-64 bg-white  transition-all duration-300 ease-in-out flex flex-col h-screen">
                ...
                <div class="px-4 w-full mb-4 sidebar-full">
                    <div class="flex">
                        <input type="text" placeholder="Search..." class="w-full p-2 border rounded bg-white text-gray-800 search-input">
                ...
                <nav class="flex-grow w-full overflow-y-auto">
                    <a href="dashboard.html" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
                        ...
                        <a href="venue.html" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
                            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path d="M3 12v3c0 1.657 3.134 3 7 3s7-1.343 7-3v-3c0 1.657-3.134 3-7 3s-7-1.343-7-3z"/><path d="M3 7v3c0 1.657 3.134 3 7 3s7-1.343 7-3V7c0 1.657-3.134 3-7 3S3 8.657 3 7z"/><path d="M17 5c0 1.657-3.134 3-7 3s-7-1.343-7-3v-3c0 1.657 3.134 3 7 3s7-1.343 7-3z"/></svg>
                            <span class="sidebar-full">Venue Management</span>
                        </a>
           
                        <a href="reservation.html" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
                        ...
                        <a href="financials.html" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
                            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path d="M5.5 2A1.5 1.5 0 004 3.5V4h12v-.5A1.5 1.5 0 0014.5 2h-9zM2 7.5A1.5 1.5 0 013.5 6h13A1.5 1.5 0 0118 7.5V8H2v-.5zM0 4.5A1.5 1.5 0 011.5 3h13A1.5 1.5 0 0116 4.5V5H0v-.5zM2 12.5A1.5 1.5 0 013.5 11h13A1.5 1.5 0 0118 12.5V13H2v-.5zM0 10.5A1.5 1.5 0 011.5 9h13A1.5 1.5 0 0116 10.5V11H0v-.5zM3.5 14A1.5 1.5 0 002 15.5V16h16v-.5a1.5 1.5 0 00-1.5-1.5h-13zM0 13.5A1.5 1.5 0 011.5 12h13A1.5 1.5 0 0116 13.5V14H0v-.5z"/></svg>
                            <span class="sidebar-full">Financial Management</span>
                        </a>
    
                        <a href="reports-analytics.html" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
                        ...
                        <a href="notifications.html" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
                            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a8 8 0 100 16 8 8 0 000-16zM5 8h10v2H5V8zm0 4h10v2H5v-2z"/></svg>
                            <span class="sidebar-full">Notifications and Alerts</span>
                        </a>
    
                        <a href="content-management.html" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
                        ...
                        <a href="promotions.html" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
                        ...
                        <a href="support.html" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
                            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"/></svg>
                            <span class="sidebar-full">Support and Helpdesk</span>
                        </a>
    
                        <a href="settings.html" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
                            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd"/></svg>
                            <span class="sidebar-full">Settings</span>
                        </a>
    
                        <a href="audit.html" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
                            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd"/></svg>
                            <span class="sidebar-full">Audit Logs</span>
                        </a>
                </nav>
            <!-- Logout button -->
            <div class="w-full mt-auto mb-4"> <!-- Added mt-auto to push it to the bottom, and mb-4 for some bottom margin -->
                ...
                <div class="container mx-auto px-6 py-8">
                    ...
                    <input type="password" id="userPassword" class="w-full p-2 border rounded" required>
                                ...
                                <div class="flex justify-end">
                                    <button type="button" class="bg-gray-500 text-white px-4 py-2 rounded mr-2" onclick="closeCreateUserModal()">Cancel</button>
                    ...
                    <section class="bg-white rounded-lg shadow-md p-6 mb-8">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <!-- Create User Button -->
                            <button class="bg-primary text-white px-4 py-2 rounded hover:bg-red-700" onclick="openCreateUserModal()">
                                Create User
                            </button>
                        </div>
