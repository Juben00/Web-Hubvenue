        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 main-content">
                <div class="container mx-auto px-4 py-8">
                    <h1 class="text-2xl md:text-3xl font-semibold text-gray-800 mb-6 hidden md:block">Account Settings
                    </h1>
                        ...
                        <form id="personal-info-form">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="role" name="role" value="Venue Manager" disabled
                    ...
                    <section id="notification-preferences" class="bg-white rounded-lg shadow-md p-6 mb-6">
                        ...
                        <form id="notification-form">
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="in-app-notifications"
                                            class="rounded border-gray-300 text-primary focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                                ...
                                <div>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="profile-visibility"
                                            class="rounded border-gray-300 text-primary focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                                        <span class="ml-2 text-sm text-gray-700">Make profile visible to other
                                            users</span>
                                    </label>
                                </div>
                                <div>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="data-sharing"
                                            class="rounded border-gray-300 text-primary focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50">
                                        <span class="ml-2 text-sm text-gray-700">Allow data sharing with third-party
                                            services</span>
                                    </label>
                                </div>
                            </div>
                    ...
                    <section id="subscription-plan" class="bg-white rounded-lg shadow-md p-6 mb-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                <h3 class="text-lg font-medium text-gray-700">Current Plan: <span
                                        id="current-plan">Premium</span></h3>
                                <p class="text-sm text-gray-600">Renewal Date: <span id="renewal-date">July 1,
                                        2023</span></p>
                            </div>
                            <div>
                                <button id="upgrade-plan"
                                    class="px-4 py-2 bg-secondary text-white rounded-md hover:bg-secondary-dark focus:outline-none focus:ring-2 focus:ring-secondary focus:ring-opacity-50">
                                    Upgrade Plan
                                </button>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center mt-2">
                                    <input type="text" id="api-key" value="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
                                        disabled class="flex-grow mr-2 p-2 bg-gray-100 rounded border border-gray-300">
                                    <button id="regenerate-api-key"
                                        class="px-4 py-2 bg-primary text-white rounded-md hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50">
                                        Regenerate
                                    </button>
                                </div>
