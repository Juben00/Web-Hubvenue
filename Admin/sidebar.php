<div id="sidebar" class="w-64 bg-white transition-all duration-300 flex flex-col h-screen">
    ...
    <nav class="flex-grow w-full overflow-y-auto">
        <a href="dashboard.php" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
        ...
        <a href="venue.php" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
        ...
        <a href="reservation.php" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
        ...
        <a href="financials.php" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
        ...
        <a href="reports-analytics.php" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
        ...
        <a href="notifications.php" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
        ...
        <a href="content-management.php" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
        ...
        <a href="promotions.php" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
        ...
        <a href="support.php" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"/></svg>
            <span class="sidebar-full">Support and Helpdesk</span>
        </a>

        <a href="settings.php" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd"/></svg>
            <span class="sidebar-full">Settings</span>
        </a>

        <a href="audit.php" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd"/></svg>
            <span class="sidebar-full">Audit Logs</span>
        </a>

        <a href="accounts-management.php" class="flex items-center text-gray-800 hover:bg-red-900 hover:text-white w-full px-4 py-2">
            <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"/></svg>
