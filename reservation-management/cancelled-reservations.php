...
// Get cancelled bookings using the new method
$Reservations = $venueObj->getAdminBookings('cancelled');
        ...
        <table class="min-w-full bg-white">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="py-2 px-4 text-left">Cancellation Reason</th>
                ...
                if (!empty($Reservations)) {
                    foreach ($Reservations as $reservation) {
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4"><?php echo $reservation['booking_cancellation_reason']; ?></td>
                            <td class="py-2 px-4">
