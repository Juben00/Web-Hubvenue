        ...
        <div class="px-4 sm:px-0">
            ...
            <div class="border-b border-gray-200 mb-6">
                <nav class="-mb-px flex space-x-8">
                    <button onclick="showTab('current')" class="tab-btn border-black text-gray-900 whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm">
                        Current Rental
                    </button>
                    <button onclick="showTab('previous')" class="tab-btn border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm">
                        Previous Rentals
                    </button>
                </nav>
            </div>
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="px-2 py-1 bg-green-100 text-green-800 rounded-full text-sm font-medium">Active</span>
                        </div>
                        <div class="flex flex-col md:flex-row gap-6">
                            <img src="/placeholder.svg?height=150&width=150" alt="Garden Orchid Room" class="w-full md:w-40 h-40 object-cover rounded-lg">
                            <div>
                                ...
                                <button onclick="showDetails('current')" class="mt-4 px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800">View Details</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="space-y-6">
                            <div class="flex flex-col md:flex-row gap-6 border-b pb-6">
                                <img src="/placeholder.svg?height=150&width=150" alt="Previous Property" class="w-full md:w-40 h-40 object-cover rounded-lg">
                                <div>
                                    ...
                                    <div class="mt-4 space-x-4">
                                        <button onclick="showDetails('prev1')" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50">View Details</button>
                                        <button onclick="bookAgain('prev1')" class="px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800">Book Again</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="relative top-20 mx-auto p-5 border w-full max-w-4xl shadow-lg rounded-md bg-white">
                    ...
                    <div id="modal-content" class="mt-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <div class="mb-4">
                                    <img id="modal-main-image" src="/placeholder.svg?height=300&width=400" alt="Venue Main Image" class="w-full h-64 object-cover rounded-lg">
                                </div>
                                <div class="grid grid-cols-3 gap-2">
                                    <img src="/placeholder.svg?height=100&width=100" alt="Venue Image 1" class="w-full h-20 object-cover rounded-lg cursor-pointer" onclick="changeMainImage(this.src)">
                                    <img src="/placeholder.svg?height=100&width=100" alt="Venue Image 2" class="w-full h-20 object-cover rounded-lg cursor-pointer" onclick="changeMainImage(this.src)">
                                    <img src="/placeholder.svg?height=100&width=100" alt="Venue Image 3" class="w-full h-20 object-cover rounded-lg cursor-pointer" onclick="changeMainImage(this.src)">
                                </div>
                            ...
                            <div>
                                ...
                                <div id="book-again-container" class="mt-6 hidden">
                                    <button onclick="bookAgain('modal')" class="w-full px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800">Book Again</button>
                                </div>
                            </div>
                        </div>
                    </div>
