    ...
    <div class="flex flex-1">
        ...
        <main class="flex-1">
            ...
            <section class="first-section relative">
                <div class="ml-20 p-8">
                    <div class="bg-white border mt-16 border-gray-300 rounded-full shadow-lg p-2 mb-8 flex items-center max-w-5xl mx-auto">
                    ...
                    <div class="mt-16 text-white rounded-3xl p-8 mb-8 max-w-5xl mx-auto relative">
                        <div class="flex items-center justify-between relative z-10">
                            <div>
                                ...
                                <button class="bg-white text-blue-500 font-semibold py-3 px-8 rounded-full hover:bg-blue-100 transition duration-300 text-lg" onclick="openModal()">
                                    Sign in or register
                                </button>
                            </div>
                ...
                <div class="cloud-bottom absolute left-0 w-full overflow-hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none" class="w-full h-64">
                        <path fill="#ffffff" fill-opacity="0.2" d="M0,224L40,229.3C80,235,160,245,240,229.3C320,213,400,171,480,165.3C560,160,640,192,720,192C800,192,880,160,960,165.3C1040,171,1120,213,1200,218.7C1280,224,1360,192,1400,176L1440,160L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path>
                        <path fill="#ffffff" fill-opacity="0.3" d="M0,256L40,245.3C80,235,160,213,240,213.3C320,213,400,235,480,240C560,245,640,235,720,224C800,213,880,203,960,213.3C1040,224,1120,256,1200,261.3C1280,267,1360,245,1400,234.7L1440,224L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path>
                        <path fill="#ffffff" fill-opacity="0.4" d="M0,288L40,277.3C80,267,160,245,240,234.7C320,224,400,224,480,229.3C560,235,640,245,720,250.7C800,256,880,256,960,245.3C1040,235,1120,213,1200,213.3C1280,213,1360,235,1400,245.3L1440,256L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path>
                        <path fill="#ffffff" fill-opacity="0.5" d="M0,288L40,282.7C80,277,160,267,240,261.3C320,256,400,256,480,261.3C560,267,640,277,720,277.3C800,277,880,267,960,261.3C1040,256,1120,256,1200,261.3C1280,267,1360,277,1400,282.7L1440,288L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path>
                        <path fill="#ffffff" d="M0,288L40,288C80,288,160,288,240,282.7C320,277,400,267,480,266.7C560,267,640,277,720,282.7C800,288,880,288,960,282.7C1040,277,1120,267,1200,266.7C1280,267,1360,277,1400,282.7L1440,288L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path>
                    </svg>
                </div>
            </section>
            ...
            <section class="bg-white py-16 relative z-10">
                <div class="ml-20 max-w-8xl mx-auto px-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-8 w-full h-full" id="venueList">
    ...
    <div id="authModal" class="fixed inset-0 bg-black bg-opacity-40 hidden items-center justify-center z-50">
        <div class="bg-white rounded-lg p-8 max-w-2xl w-full mx-4 relative shadow-2xl"> <!-- Decreased max-width -->
            ...
            <div class="flex mb-6 relative">
                <button id="loginTab" class="flex-1 py-2 px-4 text-center text-gray-500 font-semibold relative z-10 text-lg">Login</button>
                <button id="signupTab" class="flex-1 py-2 px-4 text-center text-gray-500 font-semibold relative z-10 text-lg">Sign Up</button>
                <div id="tabUnderline" class="absolute bottom-0 left-0 w-1/2 h-0.5 bg-blue-500 transition-all duration-300 ease-in-out"></div>
            </div>
            ...
            <div class="w-full">
                ...
                <form id="loginForm" class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="username" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-0" placeholder="Type your username">
                    </div>
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                        <input type="password" id="password" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-0" placeholder="Type your password">
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input type="checkbox" id="remember" class="h-4 w-4 rounded border-gray-300 text-blue-500 focus:ring-blue-500">
                            <label for="remember" class="ml-2 block text-sm text-gray-700">Remember me</label>
                        </div>
                        <a href="#" class="text-sm text-blue-500 hover:text-blue-700">Forgot password?</a>
                    </div>
                    <button type="submit" class="w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Login
                    </button>
                </form>
                ...
                <form id="signupForm" class="space-y-4 hidden">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="firstName" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-0" placeholder="Enter First Name">
                        </div>
                        <div>
                            <label for="lastName" class="block text-sm font-medium text-gray-700">Last Name</label>
                            <input type="text" id="lastName" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-0" placeholder="Enter Last Name">
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label for="mi" class="block text-sm font-medium text-gray-700">M.I.</label>
                            <input type="text" id="mi" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-0" placeholder="M.I.">
                        </div>
                        <div>
                            <label for="gender" class="block text-sm font-medium text-gray-700">Gender</label>
                            <select id="gender" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-0">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" id="birthday" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-0">
                        </div>
                        <div>
                            <label for="contactNumber" class="block text-sm font-medium text-gray-700">Contact Number</label>
                            <input type="tel" id="contactNumber" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-0" placeholder="Enter Contact Number">
                        </div>
                    </div>
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                        <input type="email" id="email" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-0" placeholder="Enter Email">
                    </div>
                    <div>
                        <label for="signupPassword" class="block text-sm font-medium text-gray-700">Password</label>
                        <input type="password" id="signupPassword" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-0" placeholder="Enter Password">
                    </div>
                    <div class="flex items-center">
                        <input type="checkbox" id="agreeTerms" class="h-4 w-4 rounded border-gray-300 text-blue-500 focus:ring-blue-500">
                        <label for="agreeTerms" class="ml-2 block text-sm text-gray-700">I agree with all the <a href="#" class="text-blue-500">terms and conditions</a> and <a href="#" class="text-blue-500">privacy policies</a> of HubVenue</label>
                    </div>
                    <button type="submit" class="w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Sign Up
                    </button>
