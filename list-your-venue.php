...
<body class="bg-white pt-16"> <!-- Added padding-top to account for fixed top bar -->
    ...
    <div class="top-bar">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            <div>
                <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false" style="display: block; fill: none; height: 32px; width: 32px; stroke: currentcolor; stroke-width: 4; overflow: visible;">
    ...
    <div class="container mx-auto px-4 py-8 max-w-2xl"> <!-- Adjusted max-width -->
        <div id="step1" class="step active">
            <h2 class="text-2xl font-semibold mb-2">Step 1</h2>
            <h1 class="text-4xl font-bold mb-4">Tell us about your place</h1>
            <p class="text-xl text-gray-600 mb-8">In this step, we'll ask you which type of property you have and if guests will book the entire place or just a room. Then let us know the location and how many guests can stay.</p>
        </div>
                ...
                <button class="w-full p-4 border rounded-lg text-left hover:border-black focus:outline-none focus:ring-2 focus:ring-black">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Guests have their own room in a home, plus access to shared spaces.</p>
                        </div>
                    </div>
                </button>
                <button class="w-full p-4 border rounded-lg text-left hover:border-black focus:outline-none focus:ring-2 focus:ring-black">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Guests sleep in a shared room in a professionally managed hostel with staff onsite 24/7.</p>
                        </div>
                    </div>
                </button>
            </div>
        ...
        <div id="step4" class="step">
            ...
            <div class="space-y-6">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center">
                        <button class="w-8 h-8 rounded-full border border-gray-400 flex items-center justify-center">-</button>
        ...
        <div id="step7" class="step">
            ...
            <p class="text-gray-600 mb-6">You'll need 5 photos to get started. You can add more or make changes later.</p>
            <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                <img src="path_to_camera_icon.jpg" alt="Camera Icon" class="mx-auto mb-4">
                <button class="bg-white text-black font-semibold py-2 px-4 border border-black rounded hover:bg-gray-100">Add photos</button>
            </div>
        </div>
        ...
        <div id="step8" class="step">
            ...
            <input type="text" class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black" placeholder="Enter title here">
        ...
        <div id="step9" class="step">
            ...
            <p class="text-gray-600 mb-6">Choose up to 2 highlights. We'll use these to get your description started.</p>
            <div class="flex flex-wrap gap-4">
                <button class="px-4 py-2 border rounded-full hover:border-black focus:outline-none focus:ring-2 focus:ring-black">
                    Peaceful
                </button>
                <button class="px-4 py-2 border rounded-full hover:border-black focus:outline-none focus:ring-2 focus:ring-black">
                    Unique
        ...
        <div id="step10" class="step">
            ...
            <textarea class="w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black" rows="6" placeholder="You'll have a great time at this comfortable place to stay."></textarea>
        ...
        <div id="step11" class="step">
            ...
            <p class="text-xl text-gray-600 mb-8">Finally, you'll choose booking settings, set up pricing, and publish your listing.</p>
        ...
        <div id="step12" class="step">
            ...
            <p class="text-gray-600 mb-6">You can change this at any time. <a href="#" class="text-black underline">Learn more</a></p>
                ...
                <div class="p-6 border rounded-xl">
                    <div class="flex items-center justify-between">
                        <div class="flex-grow">
                            ...
                            <p class="text-gray-600 text-sm mt-2">Start by reviewing reservation requests, then switch to Instant Book, so guests can book automatically.</p>
                        </div>
                        <svg class="w-8 h-8 ml-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                    </div>
                </div>
                <div class="p-6 border rounded-xl">
                    <div class="flex items-center justify-between">
                        ...
                        <svg class="w-8 h-8 ml-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="step13" class="step">
            ...
            <p class="text-gray-600 mb-6">After your first guest, anyone can book your place. <a href="#" class="text-black underline">Learn more</a></p>
            ...
            <div class="space-y-4">
                <div class="p-4 border rounded-lg flex items-center">
                    ...
                    <label for="any_guest">
                        ...
                        <p class="text-gray-600">Get reservations faster when you welcome anyone from the Airbnb community.</p>
                    </label>
                </div>
                <div class="p-4 border rounded-lg flex items-center">
                    ...
                    <label for="experienced_guest">
                        ...
                        <p class="text-gray-600">For your first guest, welcome someone with a good track record on Airbnb who can offer tips for how to be a great Host.</p>
                    </label>
                </div>
            </div>
        </div>
        ...
        <div id="step14" class="step">
            ...
            <p class="text-center text-gray-600"><a href="#" class="text-black underline">Learn more about pricing</a></p>
        </div>
        ...
        <div id="step15" class="step">
            ...
            <p class="text-center text-gray-600 text-sm mt-6">Only one discount will be applied per stay. <a href="#" class="text-black underline">Learn more</a></p>
        </div>
        ...
        <div id="step16" class="step">
            ...
            <div class="bg-gray-100 rounded-lg p-4 mb-8">
                ...
                <div class="mt-4">
                    ...
                    <p class="text-gray-600"><span class="line-through">₱2,341</span> ₱1,873 night <span class="bg-gray-200 text-gray-800 px-2 py-1 rounded-full text-xs">New</span></p>
                </div>
            </div>
            ...
            <div class="space-y-4">
                <div class="flex items-start">
                    <svg class="w-6 h-6 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    <div>
                        <h3 class="font-semibold">Confirm a few details and publish</h3>
                        <p class="text-gray-600">We'll let you know if you need to verify your identity or register with the local government.</p>
                    </div>
                </div>
                <div class="flex items-start">
                    <svg class="w-6 h-6 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                    <div>
                        <h3 class="font-semibold">Set up your calendar</h3>
                        <p class="text-gray-600">Choose which dates your listing is available. It will be visible 24 hours after you publish.</p>
                    </div>
                </div>
                <div class="flex items-start">
                    <svg class="w-6 h-6 mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                    <div>
                        <h3 class="font-semibold">Adjust your settings</h3>
                        <p class="text-gray-600">Set house rules, select a cancellation policy, choose how guests book, and more.</p>
                    </div>
                </div>
            </div>
        </div>
