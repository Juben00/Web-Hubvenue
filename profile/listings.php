                ...
                <div class="flex-grow">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-6 grid grid-cols-2 gap-4">
                                ...
                                <div class="grid grid-cols-3 col-span-2 gap-2">
                                    <img src="../images/venues/sample1.jpg" alt="" class="w-full h-32 object-cover rounded-lg cursor-pointer hover:opacity-75">
                                    <img src="../images/venues/sample2.jpg" alt="" class="w-full h-32 object-cover rounded-lg cursor-pointer hover:opacity-75">
                                    <img src="../images/venues/sample3.jpg" alt="" class="w-full h-32 object-cover rounded-lg cursor-pointer hover:opacity-75">
                                </div>
                            </div>
                            ...
                            <div class="border-b pb-6">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="flex-grow">
                                        ...
                                        <p class="text-gray-600">Amazing venue! Perfect for our wedding reception. The staff was very accommodating and professional. The place was exactly as described and the amenities were all in great condition.</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm mt-6 p-6">
                        ...
                        <div class="mt-6 border rounded-lg p-4">
                            ...
                            <p class="text-sm text-gray-600 mb-4">These apply to all nights, unless you customize them by date.</p>
                            ...
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <span class="text-sm text-gray-600">Adjust your pricing to attract more guests.</span>
                                </div>
