                            ...
                            <div class="conversation-item hover:bg-gray-50 cursor-pointer border-b relative <?php echo ((int) $user['unread_count'] > 0) ? 'bg-blue-50' : ''; ?>"
                                ...
                                <div class="p-4">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <div class="flex items-center">
                                                ...
                                                <?php if ((int) $user['unread_count'] > 0): ?>
                                                    <div
                                                        class="ml-2 bg-blue-600 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center unread-badge">
                                    ...
                                    <div class="flex justify-between items-center">
                                        <p class="text-sm text-gray-600"><?php echo htmlspecialchars($user['venue_name']); ?>
                                        </p>
