  ...
  >
    <ul class="divide-y divide-gray-200 hover:cursor-pointer">
      <li
        ...
        data-url="/web-hubvenue/profile/profile.php"
        id="profileBtn"
      >
        <span>Profile</span>
      </li>
      <li
        class="px-4 py-3 flex justify-between items-center hover:bg-slate-100 hover:font-semibold duration-150"
        data-url="/web-hubvenue/profile/notifications.php"
        id="notificationsBtn"
      >
      ...
      <li
        class="px-4 py-3 flex justify-between items-center hover:bg-slate-100 hover:font-semibold duration-150"
        data-url="/web-hubvenue/host-account-application.php"
        id="hostAccountBtn"
      >
      ...
      <li
        class="px-4 py-3 flex justify-between items-center hover:bg-slate-100 hover:font-semibold duration-150"
        data-url="/web-hubvenue/help-center.php"
        id="helpCenterBtn"
      >
      ...
      <li
        class="px-4 py-3 flex justify-between items-center hover:bg-slate-100 hover:font-semibold duration-150"
        data-url="/web-hubvenue/profile/settings.php"
        id="settingsBtn"
      >
        <span>Settings</span>
      </li>
